...
class TestCreateNote:
    @patch("subprocess.run")
    @patch("builtins.open", new_callable=mock_open, read_data="# New Note\nContent")
    ...
    @patch("subprocess.run")
    @patch("builtins.open", new_callable=mock_open)
    def test_create_note_empty_file(self, mock_file, mock_subprocess, tdo_server):
        process_mock = MagicMock()
        ...
        mock_file.assert_called_with("/path/to/empty_note.md", "w")
